...
from .views import list_technicians, list_appointments, show_appointment, show_technician, finish_appointment, cancel_appointment, list_appointment_statuses
...
urlpatterns = [
    ...
    path("appointments/statuses/", list_appointment_statuses, name="statuses"),
]
